...
describe('channel service', () => {
  ...
  describe('createChannels', () => {
    test('should create channels', async () => {
      ...
      const channelDoc2 = await channelService.getChannel(connection, { channelId: channel2.channelId });
  ...
  describe('findOneChannelAndUpdate', () => {
    ...
    test('should update an existing channel that match the filter criteria', async () => {
      await insertChannels([channel1], connection);
      const result = await channelService.findOneChannelAndUpdate(
        connection,
        { channelId: channel1.channelId },
        updateBody
      );
  ...
  describe('updateChannels', () => {
    ...
    test('should update channels that match the filter criteria', async () => {
      ...
      const channelDoc1 = await channelService.getChannel(connection, { channelId: channel2.channelId });
      const channelDoc12 = await channelService.getChannel(connection, { channelId: channel3.channelId });
