...
import { IRole, roleSchema, IRoleUpdateBody, DatabaseManager } from '@togethercrew.dev/db';
...
describe('role service', () => {
  ...
  describe('createRole', () => {
    ...
    test('should create a role', async () => {
      ...
      const roleDoc1 = await roleService.getRole(connection, { roleId: role1.roleId });
  ...
  describe('createRoles', () => {
    ...
    test('should create roles', async () => {
      ...
      const roleDoc2 = await roleService.getRole(connection, { roleId: role2.roleId });
  ...
  describe('updateRoles', () => {
    ...
    test('should update roles that match the filter criteria', async () => {
      ...
      const roleDoc1 = await roleService.getRole(connection, { roleId: role2.roleId });
      const roleDoc12 = await roleService.getRole(connection, { roleId: role3.roleId });
